...
const currentTestingLibraryVersion =
...
execSync(
  `npm install --no-save react@${currentReactVersion} react-dom@${currentReactDomVersion} @testing-library/react@${currentTestingLibraryVersion}`,
  {
    stdio: "inherit",
  }
);

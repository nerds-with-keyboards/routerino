...
- Vite 8 support, including packed-package compatibility builds on Node.js 20, 22, and 24

### Changed

- Updated the development toolchain to Vite 8 and `@vitejs/plugin-react` 6 while retaining Vite 4 through 7 compatibility
- Refreshed React, Testing Library, ESLint React Refresh, globals, and Prettier development dependencies and removed the unused Express dependency

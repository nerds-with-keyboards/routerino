    ...
    <Layout>
      <div className="page-container">
        ...
        <section className="api-section">
          ...
          <p>The main router component that manages routing in your application.</p>
          ...
          <table className="api-table">
            ...
            <tbody>
              ...
              <tr>
                <td><code>titleSeparator</code></td>
                <td><code>string</code></td>
                <td><code>" - "</code></td>
  ...
  tags: [
    ...
    { name: 'twitter:card', content: 'summary_large_image' }
        ...
        <section className="api-section">
          ...
          <h3>Syntax</h3>
          <div className="code-example">
            <pre><code>{`updateHeadTag(tagConfig: HeadTag): void`}</code></pre>
          </div>
...
updateHeadTag({
  ...
  soft: true
        ...
        <section className="api-section">
          ...
          <p>A React error boundary component for handling errors gracefully.</p>
          ...
          <table className="api-table">
            ...
            <tbody>
              ...
              <tr>
                <td><code>errorTitleString</code></td>
                <td><code>string</code></td>
...
console.log(window.routerinoParams);
// { year: "2024", month: "01", slug: "my-post" }`}</code></pre>
          </div>

          <h3>window.prerenderReady</h3>
          <p>Flag to indicate when dynamic content is ready for prerendering.</p>
          <div className="code-example">
            <pre><code>{`// Set to false while loading
...
fetchData().then(data => {
  ...
  window.prerenderReady = true;
        ...
        <section className="api-section">
          ...
          <div className="code-example">
            <pre><code>{`import type { Route, RoutePropTypes, HeadTag } from 'routerino';

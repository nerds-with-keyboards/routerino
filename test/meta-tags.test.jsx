...
describe('Meta Tag Management', () => {
  ...
  it('sets og:image from global imageUrl', () => {
    ...
    render(<Routerino routes={routes} imageUrl="https://example.com/image.jpg" />)
    
    const ogImageTag = document.querySelector('meta[property="og:image"]')
    expect(ogImageTag).toBeTruthy()
    expect(ogImageTag.getAttribute('content')).toBe('https://example.com/image.jpg')
  })
  ...
  it('prioritizes route imageUrl over global imageUrl', () => {
    ...
    render(<Routerino routes={routes} imageUrl="https://example.com/global-image.jpg" />)
    
    const ogImageTag = document.querySelector('meta[property="og:image"]')
    expect(ogImageTag.getAttribute('content')).toBe('https://example.com/route-image.jpg')
  })
  ...
  it('sets apple touch icon from touchIconUrl', () => {
    ...
    render(<Routerino routes={routes} touchIconUrl="https://example.com/icon.png" />)

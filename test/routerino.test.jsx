...
describe('Routerino', () => {
  ...
  describe('Navigation', () => {
    it.skip('navigates without page reload on click', () => {
      ...
      const routes = [
        { path: '/', element: <div><a href="/about">Go to About</a></div> },
        { path: '/about', element: <div>About Page</div> }
      ]
      ...
      expect(pushStateSpy).toHaveBeenCalledWith({}, '', 'http://localhost/about')
    ...
    it.skip('does not intercept external links', () => {
      const pushStateSpy = vi.spyOn(window.history, 'pushState')
      const routes = [
        { path: '/', element: <div><a href="https://example.com">External</a></div> }
      ]
      ...
      Object.defineProperty(event, 'target', {
        value: { tagName: 'A', href: 'https://example.com', origin: 'https://example.com' },
        enumerable: true
      })
  ...
  describe('Title Management', () => {
    ...
    it('applies separator and global title', () => {
      const routes = [
        { path: '/', element: <div>Home</div>, title: 'Home' }
      ]
